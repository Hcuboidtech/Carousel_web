...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (!auth.isLoggedIn()) {
      ...
      if (auth.getSingle("role") === "lender") {
        navigate("/dashboard-lender", { replace: true });
      } else if (auth.getSingle("role") === "borrower") {
        navigate("/dashboard-borrower", { replace: true });
      } else if (auth.getSingle("role") === "realtor") {
        navigate("/dashboard-real", { replace: true });
      } else if (auth.getSingle("role") === "attorny") {
        navigate("/dashboard-attorny", { replace: true });
      } else if (auth.getSingle("role") === "escrow") {
